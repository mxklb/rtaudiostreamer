...
cp appimage/rtaudiostreamer.desktop appimage/app.desktop
sed -i '2s/.*/Version='$version'/' appimage/app.desktop

# Move some files into the app workspace
mv appimage/app.desktop ../app/rtaudiostreamer.desktop
cp ../img/logo.png ../app/rtaudiostreamer.png
...
./linuxdeployqt-continuous-x86_64.AppImage ../app/RtAudioStreamer -appimage -extra-plugins=svg -verbose=1
